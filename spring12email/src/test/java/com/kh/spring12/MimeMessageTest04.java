...
public class MimeMessageTest04 {
    ...
    public void test() throws MessagingException, IOException {
        ...
        //도우미 객체 생성 - 파일 전송을 하면서 UTF-8로 변환해서 전송하겠다
        ...
        //첨부파일 추가
        ClassPathResource attach1 = new ClassPathResource("static/image/bg.jpg");//프로젝트에 내포된 이미지 경로
        ClassPathResource attach2 = new ClassPathResource("static/image/user.png");//프로필에 있는 이미지를 보내고 싶으면 경로를 바꿔주면 된다
