...
<body>
	...
	<!-- 검색창 -->
	<form> <!-- 현재 주소를 action으로 쓰려면 안적으면 된다 하지만 위험할 수 있으니 get방식만 이렇게 사용하는게 낫다 -->
		<fieldset>
			<legend>검색창</legend>
			...
			최종로그인 일시 
			<input type="date" name="minLoingDate" value="${vo.minLoginDate}"> ~
			<input type="date" name="maxLoingDate" value="${vo.maxLoginDate}"> 
			<br><br>
			회원등급
