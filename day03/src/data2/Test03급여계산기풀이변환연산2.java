...
public class Test03급여계산기풀이변환연산2 {
	 ...
	 */
		...
		//계산
		int pension = (int) (salary * pensionRate / 100);	//국민연금 == int pension = salary * 45 / 1000 이렇게 해도 됨
		int health = (int) (salary* healthRate / 100);	//건강보험료
		int care = (int) (health * careRate / 100); //장기요양보험료
		int emp = (int) (salary * empRate / 100); //고용보험료
