<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <form action="edit" method="post">
    	...
    	<br>
    	<br>
    	닉네임 <input type ="text" name = "memberNick" value = "${memberDto.memberNick }" required>
    	<br>
    	<br>
    	이메일 <input type ="email" name = "memberEmail" value = "${memberDto.memberEmail }" required>
    	<br>
    	<br>
    	...
    	<br>
    		<input type ="text" name = "memberAddress2" value = "${memberDto.memberAddress2 }" placeholder="상세주소">
    	<br>
    	<br>
    	등급 
