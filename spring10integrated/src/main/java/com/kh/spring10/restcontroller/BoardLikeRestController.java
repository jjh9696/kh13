...
public class BoardLikeRestController {
	...
	/*
	 * @RequestMapping("/check") public Map<String, Object> check ( HttpSession
	 * session, @RequestParam int boardNo) { String loginId =
	 * (String)session.getAttribute("loginId");
	 * 
	 * Map<String, Object> data = new HashMap<>(); data.put("state",
	 * boardLikeDao.check(loginId, boardNo)); data.put("count",
	 * boardLikeDao.count(boardNo));
	 * 
	 * return data; }
	 */	
	//하트를 클릭한 경우 실행할 매핑
