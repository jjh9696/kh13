...
public class MemberDto {
	...
	public String toString() {
		return "[아이디=" + memberId + ", 닉네임=" + memberNick 
				+ ", 생년월일=" + getMemberBirthStr() + ", 연락처=" + getMemberContactStr() 
				+ ", 이메일=" + memberEmail + ", 등급=" + memberLevel 
				+ ", 포인트=" + memberPoint + ", 가입일=" + memberJoin 
				+ ", 최종로그인시각=" + getMemberLoginStr() + "]";
	}
